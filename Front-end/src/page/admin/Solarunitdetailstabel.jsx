...
import { useGetSolarUnitsByClerkIdQuery, useGetAllSolarUnitsQuery } from "@/lib/redux/Query";
...
const SolarUnitDetailsTable = () => {
    ...
    const { data: solarUnits, isLoading, isError } = useGetAllSolarUnitsQuery();
    ...
    // Filter solar units based on search
